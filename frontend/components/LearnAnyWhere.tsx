  ...
  const features = [
    {
      ...
      image: "/images/learn-anywhere.png", // Replace with your image path
    },
    {
      ...
      image: "/images/learn-any-device.png", // Replace with your image path
    },
    {
      title: "Learn at your own pace",
      description:
        "You can learn at your own pace. Our lessons are self-paced, so you can learn as fast or as slow as you want.",
      image: "/images/learn-your-pace.png", // Replace with your image path
    },
    {
      ...
      image: "/images/learn-with-friends.png", // Replace with your image path
    },
    {
      title: "Learn in 3D",
      description:
        "You can learn in 3D. We offer virtual reality (VR) lessons that let you practice signing in a realistic 3D environment.",
      image: "/images/learn-3d.png", // Replace with your image path
    },
  ];
  ...
  return (
    <div className="bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-center text-sm w-3/5 mx-auto text-gray-600 mb-12">
