...
export default function CoursesTable() {
    ...
    return (
        <div className="space-y-4 sm:space-y-8 min-h-screen p-3 sm:p-6 lg:p-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 sm:gap-6 
                          bg-white/95 backdrop-blur-lg p-4 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl 
                          shadow-[0_0_40px_rgba(0,0,0,0.06)] border border-white/50">
                <div className="relative w-full sm:max-w-md">
                    <FiSearch className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-blue-400 w-5 h-5" />
                    <input
                        type="text"
                        placeholder="Search words..."
                        className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 border border-gray-100 rounded-lg sm:rounded-xl 
                ...
                <Link 
                    ...
                    className="w-full sm:w-auto bg-gradient-to-r from-indigo-500 to-blue-500 text-white 
                             px-4 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl 
                             hover:from-indigo-600 hover:to-blue-600 transition-all duration-300 
                             shadow-lg hover:shadow-xl transform hover:-translate-y-1 
                             font-semibold text-center border border-white/20"
                >
                    Live Translator
                </Link>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8">
                ...
                <div className="lg:col-span-4 space-y-4 sm:space-y-8">
                    ...
                    {isCourseStarted ? (
                        <div className="bg-white/95 backdrop-blur-lg p-4 sm:p-6 rounded-xl sm:rounded-2xl 
                                      shadow-[0_0_40px_rgba(0,0,0,0.06)] border border-white/50">
                            <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-indigo-600 to-blue-600 
                        ...
                        <div className="bg-white/95 backdrop-blur-lg p-4 sm:p-6 rounded-xl sm:rounded-2xl 
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6">Begin your sign language journey today!</p>
                            <button
                                onClick={startCourse}
                    ...
                    {/* Words List */}
                    <div className="bg-white/95 backdrop-blur-lg rounded-xl sm:rounded-2xl 
                                  shadow-[0_0_40px_rgba(0,0,0,0.06)] border border-white/50 p-4 sm:p-6">
                        <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-indigo-600 to-blue-600 
                                     bg-clip-text text-transparent mb-4 sm:mb-6 pb-3 sm:pb-4
                                     border-b border-gray-100">
                            Words List
                        </h2>
                        <div className="h-[calc(100vh-350px)] sm:h-[calc(100vh-200px)] overflow-y-auto 
                                      rounded-lg sm:rounded-xl bg-gray-50/50 space-y-2 p-2">
                            {filteredData.map((item, index) => {
                                const isCompleted = wordProgress?.completedWords.includes(item);
                                const isCurrent = wordProgress?.currentWord === item;
                                const isLocked = !isCompleted && !isCurrent;
                                const isSelected = selectedWord?.word === item;
                                ...
                                return (
                                    <div key={index} className="space-y-4">
                                        ...
                                        {/* Mobile Word Details */}
                                        {isSelected && (
                                            <div className="lg:hidden bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 
                                                  shadow-md space-y-3 sm:space-y-4 mt-2 sm:mt-3">
                ...
                {/* Desktop Word Details - Right Column */}
                <div className="hidden lg:block lg:col-span-8 bg-white/95 backdrop-blur-lg 
                              rounded-xl sm:rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.06)] 
